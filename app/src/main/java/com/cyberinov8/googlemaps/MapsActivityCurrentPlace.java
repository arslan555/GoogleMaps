...
public class MapsActivityCurrentPlace extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap map) {
        ...
        getDeviceLocation();
        LatLng latLng = new LatLng(29.155144,71.058224);
        mMap.addMarker(new MarkerOptions().position(latLng)).setTitle("abcdsds");
...
//        String user = Login.email.getText().toString().replace(".","%");
